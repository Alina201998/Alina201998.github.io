...
// =======
// >>>>>>> 07d8cc5 (Update portfolio and resume)
//                     </div>
        ...
        <div id="about" className='about'>
            ...
            <div className="about-sections">
                ...
                <div className="about-right">
                    <div className="about-para">
                        <p>
                            I’m a Software Developer passionate about building responsive,
                            user-friendly applications across web and mobile. I work with React,
                            JavaScript, HTML, and CSS to create clean interfaces and smooth user
                            experiences, and I also build with Java and Android Studio
                            (RecyclerView, XML/ConstraintLayout).
                        </p>

                        <p>
                            On the data side, I use SQL with SQLite and SQL Server, writing JOIN
                            queries and implementing CRUD features with strong input validation
                            and error handling. I enjoy solving real problems, writing clean code,
                            and continuously learning—shipping projects with Git/GitHub and modern
                            tooling like Vite.
                        </p>
                    </div>
